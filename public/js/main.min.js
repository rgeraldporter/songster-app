...
function create_main_fragment(state, component) {
	var div, h1, text, text_2, form, fieldset, div_1, button, text_4, button_1, button_1_hidden_value, text_8, fieldset_1, legend, text_10, div_2, label, text_12, input, input_updating = false, text_13, span, text_16, div_3, label_1, text_18, input_1, input_1_updating = false, text_19, span_1, text_22, div_4, label_2, text_24, select, option, text_25, option_1, text_26, select_updating = false, text_29, fieldset_2, legend_1, text_31, div_5, label_3, text_33, input_2, input_2_updating = false, text_34, span_2, text_37, div_6, label_4, text_39, input_3, input_3_updating = false, text_41, div_7, label_5, text_43, select_1, option_2, text_44, option_3, text_45, option_4, text_46, option_5, text_47, select_1_updating = false;
	...
	function input_1_input_handler() {
		...
		component.set({ folder: input_1.value });
		input_1_updating = false;
	}

	function select_change_handler() {
		select_updating = true;
		component.set({ sort: selectValue(select) });
	...
	function select_1_change_handler() {
		...
		component.set({ cycle: selectValue(select_1) });
	...
	return {
		c: function create() {
			...
			text_25 = createText("alphabetic");
			option_1 = createElement("option");
			text_26 = createText("random");
			text_29 = createText("\n\n    ");
			...
			text_44 = createText("Run only in daylight (diurnal)");
			option_3 = createElement("option");
			text_45 = createText("Run only at night time (nocturnal)");
			option_4 = createElement("option");
			text_46 = createText("Run only at twilight (crepuscular)");
			option_5 = createElement("option");
			text_47 = createText("Run at all times (cathemeral)");
			this.h();
		},
		...
		h: function hydrate() {
			...
			label_1.htmlFor = "interval";
			addListener(input_1, "input", input_1_input_handler);
			input_1.id = "interval";
			input_1.type = "text";
			setAttribute(input_1, "defaultvalue", "5");
			input_1.min = "0";
			input_1.max = "100";
			...
			if (!('sort' in state)) component.root._beforecreate.push(select_change_handler);
			select.id = "sort";
			...
			if (!('cycle' in state)) component.root._beforecreate.push(select_1_change_handler);
			select_1.id = "cycle";
		...
		m: function mount(target, anchor) {
			...
			appendNode(text_37, fieldset_2);
			appendNode(div_6, fieldset_2);
			appendNode(label_4, div_6);
			appendNode(text_39, div_6);
			appendNode(input_3, div_6);

			input_3.value = state.longitude;

			appendNode(text_41, fieldset_2);
			appendNode(div_7, fieldset_2);
			appendNode(label_5, div_7);
			appendNode(text_43, div_7);
			appendNode(select_1, div_7);
			appendNode(option_2, select_1);
			appendNode(text_44, option_2);
			appendNode(option_3, select_1);
			appendNode(text_45, option_3);
			appendNode(option_4, select_1);
			appendNode(text_46, option_4);
			appendNode(option_5, select_1);
			appendNode(text_47, option_5);

			selectOption(select_1, state.cycle);
		},
		...
		p: function update(changed, state) {
			...
			if (!input_updating) input.value = state.interval;
			if (!input_1_updating) input_1.value = state.folder;
			if (!select_updating) selectOption(select, state.sort);
			if (!input_2_updating) input_2.value = state.latitude;
			if (!input_3_updating) input_3.value = state.longitude;
			if (!select_1_updating) selectOption(select_1, state.cycle);
		},
